...
<!--    navigation bar ends   -->
   ...
   <!-- <div class="row" style="width: auto">
    ...
    <div class="row" style="width: auto">
        <div class="column" style="width: 19.5%; background: none; opacity: 1"></div>
        ...
        <div class="column" style="width: 59%; min-height: 200px; border: thin solid #ccc; padding-top: 70px; padding-bottom: 60px; padding-left: 30px; padding-right: 30px; opacity: 0.8">
...
<table cellspacing="30" style="padding-left: 80px; padding-top: 20px">
    ...
    <option value="Currently-Reading">Currently-Reading</option>
      ...
      prevId = id;
        ...
        <div class="column" style="width: 20.5%; background: none; opacity: 1"></div>
    </div> 
