...
div.sticky {
  ...
  opacity: .90;
    ...
    html { 
  background: url(Backgrounds/bg6.jpg) no-repeat center center fixed; 
...
<!--    navigation bar ends   -->
    ...
    <div class="row" style="width: auto">
        ...
        <div class="column" style="width: 50%; min-height: 400px; border: thin solid #ccc; padding-bottom: 80px; padding-top: 70px; padding-left: 30px; padding-right: 30px ; opacity: 0.8">
            
            <div class="row" style="width: auto"><font style="font-size: 18px">&emsp;&emsp;Most Recent Books</font><hr></div>
