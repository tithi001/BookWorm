...
div.sticky {
  ...
  opacity: .90;
    ...
    html { 
  background: url(Backgrounds/bg10.jpg) no-repeat center center fixed; 
...
<!--    navigation bar ends   -->
   ...
   <!-- <div class="row" style="width: auto">
    ...
    <div class="row" style="width: auto">
        ...
        <div class="column" style="width: 50%; min-height: 100px; border: thin solid #ccc; padding-bottom: 80px ; padding-left: 30px; padding-right: 30px; opacity: 0.80">
              ...
              if(rs.next()){
                  ...
                  <div class="row" style="width: auto">
                      <div class="column" style="width: 29%; padding-left: 30px; padding-top: 30px">
                          <img src="ProfilePics/<%=rs.getInt("user_id")%>.jpg"  height="180" width="140"><br>
                          <br><br><br>
                          <form action = "uploadpic.jsp" method = "post" enctype = "multipart/form-data">
                              <input type = "file" name = "file" accept=".jpg" style="background: none; border: thin solid #ccc; color: #3E1B0F; font-size: 14px"/>
                            <br>
                            <input type = "submit" value = "Upload File" style="background: none; aborder: thin solid #ccc; color: #3E1B0F; font-size: 14px"/>
                          </form>
