...
div.sticky {
  ...
  opacity: .90;
    ...
    html { 
  background: url(image/<%=rset.getString("book_id")%>.jpg) no-repeat center center fixed; 
...
<div class="row" style="width: auto">
        <div class="column" style="width: 17%; background: none; opacity: 1"></div>
        <div class="column" style="width: 30%;  border: thin solid #ccc; height: 700px; opacity: .80">
            <!--    this is left column   background-color: #F6F4EE; -->
...
<%--<input type="submit" value="comment"> --%>
        ...
        <div class="column" style="width: 0.5%; background: none; opacity: 1"></div>
        <div class="column" style="width: 36%; border: thin solid #ccc; height: 700px; padding-left: 30px; padding-right: 30px; opacity: .80">
...
for (Iterator iter = arr.iterator(); iter.hasNext();) {
    out.println( (iter.next()) );
      ...
      <%--  <div class="column" style="width: 20%; height: 100px; border: thin solid #ccc"> --%>
        ...
        <div class="column" style="width: 16.5%; background: none; opacity: 1"></div>
            ...
            <div class="row" style="width: auto">
               <div class="column" style="width: 17%; background: none; opacity: 1"></div>
                <div class="column" style="width: 66.5%; border: thin solid #ccc; min-height: 200px; padding-left: 40px; padding-right: 40px; padding-bottom: 80px; opacity: .80">
                    <br><br><br>&emsp;&emsp;
