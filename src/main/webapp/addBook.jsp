...
div.sticky {
  ...
  opacity: .90;
    ...
    html { 
  background: url(Backgrounds/bg2.jpg) no-repeat center center fixed; 
...
<title>BookWorm: Add a book</title>
</head>
    <body>
...
<hr color="#DEDEDE" width="4"></div><br><br><br><br><br>
<!--    navigation bar ends   -->
  <% String msg="A New Book Added!";
    String newBook= (String)session.getAttribute("newBook");
    if(newBook!=null && newBook.equals("added")){%><h3 align="center"><%=msg
    %></h3>
        <%
...
<br><br><br>
     <div  class="row" style="width: auto ">
        ...
        <div class="column" style="width: 50%; min-height: 400px; border: thin solid #ccc; padding-bottom: 80px; padding-top: 70px; padding-left: 30px; padding-right: 30px; opacity: 0.80">
            <div class="row" style="width: auto"><font style="font-size: 18px">&emsp;&emsp;Add New Books</font><hr></div>
            <div class="row" style="width: auto; padding-top: 40px; padding-left: 30px; padding-right: 30px" >
                <form method="post" action="Add_New_Book" name="bookform" style="padding-left: 20px">
                    <br><table cellspacing="30">
                        <tr>
                            <td>
                                Book Name:
                            </td>
                            <td colspan="2">
                                <input type="text" style="width:300px; height:35px;" name="book_name" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="2">
                                <input type="date" style="width:300px; height:35px;" name="release_date" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="2">
                                <input type="text" style="width:300px; height:35px;" name="author_name" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="genre" value="<%=gname.get(i)%>"/> <%=gname.get(i) %><br>
                                <% }%><br>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <textarea rows="6" cols="35" name="description" form="bookform" required></textarea>
                            </td>
                        </tr>
                    </table><br><br>
                    <p align="center"><input type="submit" value="Add new Book" style="background: none; border: thin solid #ccc; color: #3E1B0F; font-size: 14px; padding-top: 3px; padding-bottom: 3px"></p>
