...
<div class="topnav" style="border-bottom: thin solid #ccc; box-shadow: 0 5px 5px -5px #ccc">
 ...
 <%}%>
    ...
    <hr color="#DEDEDE" width="4"></div><br><br><br><br><br><br>
<!--    navigation bar ends   -->
    ...
    String oldPassword= (String)session.getAttribute("deleteUser");
    if(oldPassword!=null && oldPassword.equals("deleted")){%><h3 align="center"><%=msg
    %></h3>
        <%
    ...
    %>  
            ...
            <div class="row" style="width: auto"><font style="font-size: 18px">&emsp;&emsp;All Users</font><hr></div>
            <div class="row" style="width: auto; padding-top: 40px; padding-left: 30px; padding-right: 30px" >
                <table cellspacing="70"  >
                
        
        <% ResultSet rs = (ResultSet)session.getAttribute("profile_info");
            while (rs.next()){
        ...
        <tr>
            ...
            <td><img src="ProfilePics/<%=rs.getInt("user_id")%>.jpg"  height="180" width="140" style="padding-right: 20px"></td>
          <td>  <br>Username:<%=rs.getString("USERNAME") %><br>
              <br>    Address:<%=rs.getString("ADDRESS") %><br><br>
          Phone Number:<%=rs.getString("PHONE_NUMBER") %><br><br>
          Email: <%=email %><br><br>
           Age: <%=rs.getInt("AGE") %><br><br>
            ...
            <td>
                <a href="deleteUser?email=<%=email%>"><input type="button" value="delete" 
                    onclick="return confirm ('Are you sure want to delete?');" 
                    style="background: none; border: thin solid #ccc; color: #3E1B0F; font-size: 14px"></a><br>
    ...
    <%}%>
        ...
        <% rs = (ResultSet)session.getAttribute("profile_inf");
            while (rs.next()){   
        String email=rs.getString("EMAIL");
        %>
        <tr>
