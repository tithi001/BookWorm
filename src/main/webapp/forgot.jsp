...
* {box-sizing: border-box;}
      ...
      <title>BookWorm: Forgot Password</title>
    </head>
...
<div class="topnav" style="border-bottom: thin solid #ccc; box-shadow: 0 5px 5px -5px #ccc">
    ...
    <div class="column" style="width: 10%; background-color: #EFEAE2; float: right"></div>
     <% Object username_obj = session.getAttribute("username"); 
     if(username_obj != null){String username=(String)username_obj;
...
<font style="font-size: 18px">Password Reset Form</font><br>
      <hr>
<form name="myform"   action="Forgot" method="post" onsubmit="return validateform()"><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Email<br><br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button class="button" type="submit" value="FOrgot" style="border: thin solid #ccc; color: #3E1B0F; font-size: 14px; background: none">
                 Reset
            </button><br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
